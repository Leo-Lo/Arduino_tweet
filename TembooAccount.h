...
#define TEMBOO_ACCOUNT "sammoore21"  // Your Temboo account name 
#define TEMBOO_APP_KEY_NAME "Tweet"  // Your Temboo app key name
#define TEMBOO_APP_KEY "EEKOS6lHqsbS1NwO33CJLaHWF9bJcLKR"  // Your Temboo app key
